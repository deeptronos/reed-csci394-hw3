...
void Land::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " and ";
    expn->output(os);
    os << std::endl;
...
void Lorr::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " or ";
    expn->output(os);
    os << std::endl;
...
void Less::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " < ";
    expn->output(os);
    os << std::endl;
...
void Lsql::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " <= ";
    expn->output(os);
    os << std::endl;
...
void Equl::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " == ";
    expn->output(os);
    os << std::endl;
...
void Dont::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " not ";
    expn->output(os);
    os << std::endl;
...
void Doif::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " if ";
    expn->output(os);
    os << std::endl;
...
void Dowh::output(std::ostream& os, std::string indent) const {
    os << indent;
    os << name << " while ";
    expn->output(os);
    os << std::endl;
...
void MinusEqual::dump(int level) const {
    dump_indent(level);
...
void Lsql::dump(int level) const {
    dump_indent(level);
    std::cout << "LSQL" << std::endl;
    dump_indent(level+1);
    std::cout << name << std::endl;
    expn->dump(level+1);
}
...
void Dont::dump(int level) const {
    dump_indent(level);
...
void Doif::dump(int level) const {
    dump_indent(level);
    std::cout << "DOIF" << std::endl;
    dump_indent(level+1);
    std::cout << name << std::endl;
    expn->dump(level+1);
}

void Dowh::dump(int level) const {
    dump_indent(level);
    std::cout << "DOWH" << std::endl;
    dump_indent(level+1);
    std::cout << name << std::endl;
    expn->dump(level+1);
}

void Land::dump(int level) const {
    dump_indent(level);
...
void Lorr::dump(int level) const {
    dump_indent(level);
    std::cout << "LORR" << std::endl;
    dump_indent(level+1);
    std::cout << name << std::endl;
    expn->dump(level+1);
}
